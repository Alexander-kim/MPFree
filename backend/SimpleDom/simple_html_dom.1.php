...
//    $contents = file_get_contents($url, $use_include_path, $context, $offset);
	$contents = GetWebSite($url, $use_include_path, $context, $offset);
...
class simple_html_dom {
 ...
 //       $this->load(call_user_func_array('file_get_contents', $args), true);
		$this->load(call_user_func_array('GetWebSite', $args), true);
...
function GetWebSite($pURL)
{
  $lUserAgent = "Mozilla/5.0 (Windows NT 5.1) AppleWebKit/535.7 (KHTML, like Gecko) Chrome/16.0.912.75 Safari/535.7";
  $lCURL = curl_init();
  curl_setopt ($lCURL, CURLOPT_URL, $pURL);
...
//  $header[] = "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,* / *;q=0.8";
  $header[] = "Accept-Languate: de-DE,de;q=0.8,en-US;q=0.6,en;q=0.4,nl;0.2";
  $header[] = "Accept-Charset: ISO-8859-1,utf-8;q=0.7,*;q=0.3";
  curl_setopt($lCURL, CURLOPT_HTTPHEADER, $header);
*/
 
  $lRetVal = curl_exec ($lCURL);
  curl_close ($lCURL);
